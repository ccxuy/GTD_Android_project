 ...
 * {@link GtdEventFolderDetailActivity} representing item details. On tablets,
 * the activity presents the list of items and item details side-by-side using
 * two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link GtdEventFolderListFragment} and the item details (if present) is a
 * {@link GtdEventFolderDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link GtdEventFolderListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class GtdEventFolderListActivity extends FragmentActivity implements
	...
	/**
	 * Callback method from {@link GtdEventFolderListFragment.Callbacks}
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			arguments.putString(GtdEventFolderDetailFragment.ARG_ITEM_ID, id);
			GtdEventFolderDetailFragment fragment = new GtdEventFolderDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.gtdeventfolder_detail_container, fragment)
					.commit();
			...
			Intent detailIntent = new Intent(this,
					GtdEventFolderDetailActivity.class);
			detailIntent.putExtra(GtdEventFolderDetailFragment.ARG_ITEM_ID, id);
